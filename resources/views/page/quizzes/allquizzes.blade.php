                            ...
                            @foreach ($quizs as $index => $quiz)
                                <tr class="bg-white border-b  hover:bg-gray-50 ">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <a href="#" data-quiz-id="{{$quiz->id}}" data-tooltip-target="tooltip-impq" data-modal-target="import-quiz-modal{{ $quiz->id }}" data-modal-toggle="import-quiz-modal{{ $quiz->id }}" class="text-lg text-yellow-500  hover:text-yellow-700 hover:underline"><i class="bi bi-box-arrow-in-down"></i></a>
                                        ...
                                        <!-- Main modal -->
                                        <div id="import-quiz-modal{{ $quiz->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                            <div class="relative p-4 w-full max-w-2xl max-h-full">
                                                <!-- Modal content -->
                                                <div class="relative bg-white rounded-lg shadow">
                                                    <!-- Modal header -->
                                                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                                                        <h3 class="text-xl font-semibold text-gray-900">
                                                            นำเข้าข้อสอบ{{ $quiz->id }}
                                                        </h3>
                                                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="import-quiz-modal{{ $quiz->id }}">
                                                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                                                            </svg>
                                                    ...
                                                    <form action="{{ route('quiz.importques', ['qid' => $quiz->id]) }}" method="post">
                                                        ...
                                                        <!-- Modal body -->
                                                        <div class="p-4 md:p-5 space-y-4">
                                                            <div id="quizcontainer{{ $quiz->id }}" class="overflow-auto max-h-screen">
                                                            ...
                                                            <button type="button" id="addquiznumbtn" onclick="addQuiz('{{ $quiz->id }}')" class="text-white mx-1 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-1 text-center "><i class="bi bi-plus-lg"></i></button>
                                                            ...
                                                            <script>
                                                                let num = 2;
                                                                function addQuiz(modalId) {
                                                                    var quizContainer = document.getElementById('quizcontainer' + modalId);
                                                        ...
                                                        <!-- Modal footer -->
                                                        <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b ">
                                                            <button data-modal-hide="import-quiz-modal{{ $quiz->id }}" type="submit" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Save</button>
                                                            <button data-modal-hide="import-quiz-modal{{ $quiz->id }}" type="button" class="py-2.5 mx-1 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 ">Decline</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
