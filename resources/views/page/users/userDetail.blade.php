                ...
                <div class="bg-white rounded-4 mb-5 shadow-sm">
                    ...
                    <div class="d-flex justify-content-evenly">
                        <div class="d-flex justify-content-center align-items-center my-3 w-100">
                            <img src="/img/icons/{{ $user->icon }}"
                                style="object-fit: cover; width: 200px; height:200px" class="rounded-circle"
                                width="200" alt="">
                        </div>
                        <div class="my-3 w-100 px-4">
                            <div class="input-group input-group-sm mb-2">
                                ...
                                <input type="text" class="form-control" id="username" name="username"
                                    value="{{ $user->username }}" aria-label="Username" aria-describedby="basic-addon1"
                                    disabled>
                            </div>
                            <div class="input-group input-group-sm mb-2">
                                <span class="input-group-text" id="basic-addon1">{{ __('messages.Password') }}</span>
                                <input type="password" class="form-control" id="password" name="password"
                                    value="" aria-label="Username" aria-describedby="basic-addon1" disabled>
                            </div>
                            <div class="input-group input-group-sm mb-2">
                                <span class="input-group-text" id="basic-addon1">{{ __('messages.Name') }}</span>
                                <input type="text" class="form-control" name="name" id="name"
                                    value="{{ $user->name }}" aria-label="Username" aria-describedby="basic-addon1"
                                    disabled>
                            </div>
                            <div class="input-group input-group-sm mb-2">
                                ...
                                <select class="form-select form-select-sm" id="agn" name="agn" disabled>
                                    @foreach ($agns as $agn)
                                        <option value="{{ $agn->id }}"
                                            @if ($user->agency == $agn->id) selected @endif>{{ $agn->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="input-group input-group-sm mb-2">
                                ...
                                <select class="form-select form-select-sm" id="brn" name="brn" disabled>
                                    @foreach ($brns as $brn)
                                        <option value="{{ $brn->id }}"
                                            @if ($user->brn == $brn->id) selected @endif>{{ $brn->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="input-group input-group-sm mb-2">
                                ...
                                <select class="form-select form-select-sm" name="dpm" id="dpm" disabled>
                                    @foreach ($dpms as $dpm)
                                        <option value="{{ $dpm->id }}"
                                            @if ($user->dpm == $dpm->id) selected @endif>{{ $dpm->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select class="form-select form-select-sm" name="role" id="role" disabled>
                                    @foreach ($roles as $role)
                                        <option value="{{ $role->name }}"
                                            @if ($user->role == $role->name) selected @endif>{{ $role->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="d-flex justify-content-center mb-3 gap-2">
                        ...
                        <button class="btn btn-danger" id="cancelBtn"
                            style="display: none;">{{ __('messages.Cancel') }}</button>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-4 mb-4 shadow-sm">
                    <div class="text-center my-3">
                        <div class="my-4 flex justify-between px-4">
                            ...
                            <div>
                                <button class="btn btn-success" id="addC2User" title="Add course"><i
                                        class="bi bi-plus-lg"></i> course</button>
                                <button class="btn btn-info" id="addG2User" title="Add course group"><i
                                        class="bi bi-plus-lg"></i> group</button>
                            </div>
                        </div>
                        <div>
                            <table class="table table-hover" id="course-datatable">
                                ...
                                <tbody class="text-start">
                                    @foreach ($ucourse as $course)
                                        @php
                                            $prog_finish = App\Models\progress::where('user_id', $id)
                                            ...
                                            $user_course = App\Models\user_has_course::where('user_id', $id)
                                                ->where('course_id', $course->id)
                                                ->first();
                                        @endphp
                                        <tr>
                                            <th scope="row"><button class="text-danger delete-btn"
                                                    value="{{ $course->id }}" userId="{{ $user->id }}"><i
                                                        class="bi bi-trash"></i></button></th>
                                            <td>{{ $course->code }}</td>
                                            <td data-toggle="tooltip" data-placement="top"
                                                title="{{ $course->title }}">{{ Str::limit($course->title, 60) }}
                                            </td>
                                            <td>
                                ...
                                <tbody class="table-group-divider">
                                    @foreach ($ownCourse as $index => $ocourse)
                                        <tr>
                                            ...
                                            <td>{{ $ocourse->code }}</td>
                                            <td data-toggle="tooltip" data-placement="top"
                                                title="{{ $ocourse->title }}">{{ Str::limit($ocourse->title, 60) }}
                                            </td>
                                            <td>
                                                {{ $ocourse->created_at ?? '' }}
                                            </td>
                                    ...
                                    @foreach ($tests as $index => $test)
                                        <tr>
                                            ...
                                            <td class="text-nowrap" data-toggle="tooltip" data-placement="top"
                                                title="{{ optional($test->getQuiz)->title }}">
                                                {{ optional($test->getQuiz)->title }}</td>
        ...
        $('#test-datatable').DataTable({
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    messageBottom: 'Printed on ' + url.origin +
                        ' by {{ auth()->user()->name }} at ' + dateString,
                    customize: function(doc) {
                        ...
                        $(doc.document.body)
                            .prepend(
                            imgContainer); // Adjust this if the image needs to go somewhere specific
            ...
            fetch('/user/update', {
                ...
                .then(response => {
                    if (!response.ok) {
                        ...
                        return response
                    .json(); // This line is crucial. Return the result of response.json().
                    }
                })
                .then(data => {
