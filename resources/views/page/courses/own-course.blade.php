                        ...
                        @foreach ($groups as $index => $group)
                            <div class="hidden p-2 rounded-lg" id="group{{ $group->id }}" role="tabpanel" aria-labelledby="group-{{ $group->id }}-tab">
                                <div class="mb-4 inline-flex rounded-md shadow-sm" role="group">
                                    <button disabled type="button" class="px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-s-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700">
                                      Edit group
                                    </button>
