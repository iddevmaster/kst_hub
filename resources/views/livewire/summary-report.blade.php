        ...
        <div class="flex-auto">
            <form wire:submit.prevent="searchTest">
                <div class="flex gap-2 mb-2">
                    <select id="filterUser" wire:model="formData.filter_user" aria-label="Filter user"
                    ...
                    <select id="filterBrn" wire:model="formData.filter_brn" aria-label="Filter brn"
                        class="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="flex gap-2">
                    <select id="filterQuiz" wire:model="formData.filter_quiz" aria-label="Filter quiz"
                        class="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <input type="date" id="startDate" wire:model="formData.filter_sdate" value="{{ $formData['filter_sdate'] }}"
